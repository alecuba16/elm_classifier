myInference <- function(y, x = NULL, 
    ...
    dep<-dependencyLoader(c('openintro','BHH2',paste0("functions_common/",c('chiTail.R','FTail.R','normTail.R'))))
    ...
    # source("functions_common/chiTail.R")
    # source("functions_common/FTail.R")
    # source("functions_common/normTail.R")
    ...
    if(any(c(eda_plot,inf_plot,inf_lines))){
    ...
    if(any(c(eda_plot,inf_plot,inf_lines))) par(mfrow = c(1,1), mar = c(5,4,4,2)+0.1)
}
